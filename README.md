...
Generate a consistent four-image portrait series covering the product
ecosystem, XWorkmate, XConnect, and AI Workspace:
...
The renderer uses deterministic Pillow layout and system CJK fonts, so the
Chinese copy remains editable and does not depend on generated image text.
